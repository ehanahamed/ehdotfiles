...
beautiful.init("/home/ehan/.config/awesome/default/theme.lua")
...
client.connect_signal("request::titlebars", function(c)
    ...
    local customTitlebar = awful.titlebar(c, {
        bg_normal = beautiful.titlebarBgColor,
        bg_focus = beautiful.titlebarBgColor,
    })
